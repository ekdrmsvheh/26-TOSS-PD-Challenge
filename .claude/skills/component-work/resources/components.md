...
- SelectTrigger: 커스텀 드롭다운(캘린더 등) 진입점 버튼. 값 텍스트 + placeholder + 필수 표시 (`components/input/SelectTrigger.jsx`)
- AttendeeRow: 미팅 참석자 행. 아바타/이름/역할/필수·권장·선택 레벨/주최자 뱃지/삭제 버튼 (`components/input/AttendeeRow.jsx`)
...
- MeetingScheduleForm: 밋핏의 미팅 스케줄 요청 폼. 유동 폼 + sticky 300px 요약 패널 (`components/templates/MeetingScheduleForm.jsx`)
